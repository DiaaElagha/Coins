...
namespace Coins.Data.Migrations
{
    ...
    [Migration("20221125145805_add-column-title_ar_en-in-sliderhome")]
    partial class addcolumntitle_ar_eninsliderhome
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Coins.Core.Models.Domins.Home.SliderHome", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int?>("StoreBranchIdButton")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("StoreBranchIdButton");
            ...
            modelBuilder.Entity("Coins.Core.Models.Domins.StoresInfo.StoreUserFavorites", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Coins.Entities.Domins.Auth.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7ba81007-e195-4ae0-a994-8708f2d66531",
                            CreateAt = new DateTimeOffset(new DateTime(2022, 11, 25, 16, 58, 4, 267, DateTimeKind.Unspecified).AddTicks(8353), new TimeSpan(0, 2, 0, 0, 0)),
                            ...
                            PasswordHash = "ADaYJtNrhaiJQ3eqoYRsvP/5M7zfV/D0RKsMeFDNwGrdcO92W8AkPZqMxfXd/TtNMg==",
            ...
            modelBuilder.Entity("Coins.Core.Models.Domins.Home.SliderHome", b =>
                {
                    ...
                    b.HasOne("Coins.Entities.Domins.StoresInfo.StoreBranchs", "StoreBranch")
                        .WithMany()
                        .HasForeignKey("StoreBranchIdButton");
            ...
            modelBuilder.Entity("Coins.Core.Models.Domins.StoresInfo.StoreUserFavorites", b =>
                {
                    ...
                    b.HasOne("Coins.Entities.Domins.StoresInfo.StoreBranchs", "StoreBranch")
                        .WithMany("StoreUserFavoritesList")
                        .HasForeignKey("StoreBranchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Coins.Entities.Domins.StoresInfo.StoreBranchs", b =>
                {
                    ...
                    b.Navigation("StoreUserFavoritesList");
